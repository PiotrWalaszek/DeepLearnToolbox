...
for i = 1 : numepochs
   ...
   t2 = toc(evalt);
        disp(['epoch ' num2str(i) '/' num2str(opts.numepochs)  ...
             '. Sum squared error on training set is '...
            num2str(sum(L((n-numbatches):(n-1)))) '. Matthews correlation coefficient is ' ...
            num2str(0.0+loss.train.e_errfun(i)) ' Learningrate: ' num2str(nn.learningRate) ' Momentum: ' num2str(nn.momentum)]);
